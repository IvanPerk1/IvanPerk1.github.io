const translations = {
    en: {
        ...
        'step2-desc': 'Download installer and run. Agent automatically configures Firewall, Network, and everything else!',
    ...
    ru: {
        ...
        'step2-desc': 'Скачайте установщик и запустите. Агент автоматически настроит Брандмауэр, Сеть и всё остальное!',
    ...
    uk: {
        ...
        'step2-desc': 'Завантажте інсталятор та запустіть. Агент автоматично налаштує Брандмауер, Мережу та все інше!',
